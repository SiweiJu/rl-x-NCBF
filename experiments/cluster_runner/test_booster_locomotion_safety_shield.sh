#!/bin/bash
#SBATCH --job-name=booster_shield_test
...
export EXP_NAME="${EXP_NAME:-booster_locomotion_safety_shield}"
...
echo "Running Booster locomotion shield sweep: use_safety_layer=${USE_SAFETY_LAYER}, eta_cbf=${NCBF_ETA_CBF}, gamma_c=${NCBF_GAMMA_C}, run_name=${RUN_NAME}"
