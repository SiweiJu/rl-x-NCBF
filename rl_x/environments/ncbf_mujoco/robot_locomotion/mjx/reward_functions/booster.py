...
class BoosterReward:
    ...
    def reward_and_info(self, data, mjx_model, internal_state, action, info):
        ...
        info["reward/power_draw_penalty"] = energy_reward
        info["reward/z_velocity"] = z_vel_reward
        info["reward/roll_pitch_vel"] = roll_pitch_vel_reward
        info["reward/joint_velocity"] = joint_vel_reward
        info["reward/joint_acceleration"] = acceleration_reward
        info["reward/root_acceleration"] = root_acceleration_reward
