...
def apply_booster_defaults(config):
    ...
    # Keep Booster locomotion on the same reward scale as G1. Booster-specific
    # reward keys stay present for compatibility, but the humanoid reward
    # handler now uses the G1 profile and the extra Booster-only terms are zero.
    config.reward.update({
        "profile": "g1",
        "critical_initial_coeff": 0.5,
        "critical_final_coeff": 1.0,
        ...
        "foot_flat_contact_coeff": 0.01,
        "survival": 0.0,
        "tracking_w_sum_linvel_x": 0.0,
        "tracking_w_sum_linvel_y": 0.0,
        "tracking_w_sum_angvel": 0.0,
        "tracking_nominal_joint_pos_coeff": 0.0,
        "feet_swing_coeff": 0.0,
        "joint_deviation_l1_coeff": 0.0,
        "energy_coeff": 0.0,
        "z_vel_coeff": 0.0,
        "joint_vel_coeff": 0.0,
        "joint_acc_coeff": 0.0,
        "root_acc_coeff": 0.0,
        "feet_slip_coeff": 0.0,
        "feet_yaw_diff_coeff": 0.0,
        "feet_yaw_mean_coeff": 0.0,
        "feet_roll_coeff": 0.0,
        "feet_distance_coeff": 0.0,
        "air_time_coeff": 0.0,
        "no_fly_coeff": 0.0,
...
def apply_boosterball_defaults(config):
    ...
    config.ball_plate.update({
        "enabled": True,
        "include_observations": True,
        "plate_home_pos": [0.2995, 0.0, 0.792],
        "plate_home_quat": [1.0, 0.0, 0.0, 0.0],
        "plate_size": [0.18, 0.24, 0.008],
        "ball_home_pos": [0.2995, 0.0, 0.84],
        ...
        "support_contact_geom_names": ["left_hand_col", "right_hand_col", "left_forearm_col", "right_forearm_col"],
        "torso_contact_geom_names": ["torso_col"],
        "arm_contact_geom_names": ["left_upper_arm_col", "right_upper_arm_col"],
        "preserve_contact_geom_names": [
            "left_hand_col", "right_hand_col",
            "left_forearm_col", "right_forearm_col",
            "left_upper_arm_col", "right_upper_arm_col",
            "torso_col",
        ],
        "mjx_capsule_contact_geom_names": [
            "left_hand_col", "right_hand_col",
            "left_upper_arm_col", "right_upper_arm_col",
        ],
        "fist_radius": 0.035,
        "fist_half_length": 0.055,
        "randomize_capsule_hand_mass": False,
        "randomize_capsule_hand_size": False,
    ...
    config.ball_plate.initial_joint_positions = config_dict.ConfigDict({
        "Left_Shoulder_Pitch": -0.31,
        "Left_Shoulder_Roll": -1.6,
        "Left_Elbow_Pitch": 0.35,
        "Left_Elbow_Yaw": -1.31,
        "Right_Shoulder_Pitch": -0.31,
        "Right_Shoulder_Roll": 1.6,
        "Right_Elbow_Pitch": 0.35,
        "Right_Elbow_Yaw": 1.31,
    })
    config.reward.update({
        "type": "humanoidball",
        "profile": "g1",
