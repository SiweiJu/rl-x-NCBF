...
def get_config(environment_name):
    config = {
        ...
        "ball_plate": {
            ...
            "plate_parent_body": "left_elbow_roll_link",
            "plate_pos": [0.146, -0.23, 0.196],
            "plate_quat": [0.84826545, -0.08511044, -0.52007597, -0.05218165],
        ...
        "reward": {
            ...
            "foot_air_time_per_robot_size_m": 0.2,
            "all_feet_off_ground_coeff": 3.0,
            "critical_initial_coeff": 0.5,
            "style_initial_coeff": 0.1,
