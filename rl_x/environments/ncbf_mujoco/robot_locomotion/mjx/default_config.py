    ...
    config = {
        ...
        "domain_randomization": {
            ...
            "observation_noise": {
                ...
                "gravity_vector": 0.05,
                "exteroception": 0.03,
                "add_ball_plate_obs_noise": False,
...
def apply_boosterball_defaults(config):
    ...
    config.ball_plate.update({
        "enabled": True,
        "include_observations": True,
        "plate_home_pos": [0.4206, 0.0, 0.9089],
        "plate_home_quat": [1.0, 0.0, 0.0, 0.0],
        "plate_size": [0.18, 0.24, 0.008],
        "ball_home_pos": [0.4206, 0.0, 0.9569],
        "left_fist_body": "left_hand_link",
        "right_fist_body": "right_hand_link",
        "left_fist_pos": [0.0, 0.205, 0.0],
        "right_fist_pos": [0.0, -0.205, 0.0],
        "use_capsule_hand": False,
        "add_support_fist_geoms": False,
        "add_torso_plate_guard": False,
        "add_upper_arm_plate_guards": False,
        "add_forearm_plate_guards": True,
        "support_contact_geom_names": ["left_forearm_plate_guard", "right_forearm_plate_guard"],
        "torso_contact_geom_names": ["torso_col"],
        "arm_contact_geom_names": ["left_upper_arm_col", "right_upper_arm_col", "left_hand_col", "right_hand_col"],
        "arm_self_contact_geom_pairs": [
            ["left_forearm_col", "right_forearm_col"],
            ["left_forearm_col", "right_hand_col"],
            ["left_hand_col", "right_forearm_col"],
            ["left_hand_col", "right_hand_col"],
            ["left_upper_arm_col", "right_upper_arm_col"],
            ["left_upper_arm_col", "right_forearm_col"],
            ["right_upper_arm_col", "left_forearm_col"],
            ["left_upper_arm_col", "right_hand_col"],
            ["right_upper_arm_col", "left_hand_col"],
        ],
        "preserve_contact_geom_names": ["left_forearm_col", "right_forearm_col", "left_forearm_plate_guard", "right_forearm_plate_guard", "left_hand_col", "right_hand_col", "left_upper_arm_col", "right_upper_arm_col", "torso_col"],
        "mjx_capsule_contact_geom_names": ["left_hand_col", "right_hand_col", "left_upper_arm_col", "right_upper_arm_col"],
        "fist_radius": 0.031,
        ...
        "left_forearm_contact_fromto": [0.0, -0.08, 0.0, 0.0, 0.72, 0.0],
        "right_forearm_contact_fromto": [0.0, 0.08, 0.0, 0.0, -0.72, 0.0],
        "upper_arm_contact_radius": 0.055,
        "forearm_contact_radius": 0.031,
        "plate_torso_contact_friction": [1.5, 1.5, 0.005, 0.0001, 0.0001],
        "plate_arm_contact_friction": [1.5, 1.5, 0.005, 0.0001, 0.0001],
        "plate_support_contact_friction": [3.0, 3.0, 0.005, 0.0001, 0.0001],
        "plate_support_contact_dim": 6,
        ...
        "arm_self_contact_friction": [1.5, 1.5, 0.005, 0.0001, 0.0001],
        "arm_self_contact_dim": 3,
        "arm_self_contact_solref": [0.005, 1.0],
        "arm_self_contact_solimp": [0.99, 0.999, 0.0001, 0.5, 2.0],
        "arm_self_contact_margin": 0.002,
    })
    config.ball_plate.initial_joint_positions = config_dict.ConfigDict({
        "Left_Shoulder_Pitch": -1.1825,
        "Left_Shoulder_Roll": -1.0593,
        "Left_Elbow_Pitch": 1.3726,
        "Left_Elbow_Yaw": -1.5704,
        "Right_Shoulder_Pitch": -1.1825,
        "Right_Shoulder_Roll": 1.0593,
        "Right_Elbow_Pitch": 1.3726,
        "Right_Elbow_Yaw": 1.5704,
    })
