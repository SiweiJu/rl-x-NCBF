...
def apply_boosterball_defaults(config):
    ...
    config.ball_plate.update({
        ...
        "add_forearm_plate_guards": False,
        ...
        "preserve_contact_geom_names": ["left_forearm_col", "right_forearm_col", "left_hand_col", "right_hand_col", "left_upper_arm_col", "right_upper_arm_col", "torso_col"],
    ...
    config.ball_plate.initial_joint_positions = config_dict.ConfigDict({
        "Left_Shoulder_Pitch": -1.2103,
        "Left_Shoulder_Roll": -1.237,
        "Left_Elbow_Pitch": 1.1669,
        "Left_Elbow_Yaw": -0.9076,
        "Right_Shoulder_Pitch": -1.2103,
        "Right_Shoulder_Roll": 1.237,
        "Right_Elbow_Pitch": 1.1669,
        "Right_Elbow_Yaw": 0.9076,
    })
