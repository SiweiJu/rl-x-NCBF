...
def get_config(environment_name):
    config = {
        ...
        "reward": {
            ...
            "standing_still_bonus_coeff": 0.0,
            "standing_still_xy_velocity_temperature": 0.04,
            "standing_still_yaw_velocity_temperature": 0.04,
            "standing_still_joint_velocity_temperature": 25.0,
            "standing_nominal_joint_pos_bonus_coeff": 0.0,
            "standing_nominal_joint_pos_temperature": 0.1,
