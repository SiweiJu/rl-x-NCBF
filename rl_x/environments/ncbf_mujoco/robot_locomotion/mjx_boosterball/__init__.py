...
ROBOT_LOCOMOTION_MJX_BOOSTERBALL_ENV = extract_environment_name_from_file(__file__)
register_environment(ROBOT_LOCOMOTION_MJX_BOOSTERBALL_ENV, get_config, create_env, GeneralProperties)
