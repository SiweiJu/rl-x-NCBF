...
class DefaultG1Reward(DefaultReward):
    def __init__(self, env):
        ...
        self.standing_nominal_joint_pos_bonus_coeff = reward_config.get("standing_nominal_joint_pos_bonus_coeff", 0.0) * env.dt
        self.standing_nominal_joint_pos_temperature = reward_config.get("standing_nominal_joint_pos_temperature", 0.1)
    ...
    def reward_and_info(self, action):
        ...
        standing_nominal_joint_pos_score = np.exp(
            -standing_nominal_joint_pos_norm / self.standing_nominal_joint_pos_temperature
        )
        standing_nominal_joint_pos_bonus_reward = (
            self.standing_nominal_joint_pos_bonus_coeff
            * standing_command_scale
            * standing_nominal_joint_pos_score
        )
        ...
        standing_reward = standing_still_bonus_reward + standing_nominal_joint_pos_bonus_reward
        pre_clip_total = (
        ...
        self.env.internal_state["info"][f"reward/standing_still_bonus"] = standing_still_bonus_reward
        self.env.internal_state["info"][f"reward/standing_nominal_joint_pos_bonus"] = standing_nominal_joint_pos_bonus_reward
        self.env.internal_state["info"][f"reward/standing_total"] = standing_reward
        ...
        self.env.internal_state["info"][f"env_info/standing_still_bonus_score"] = standing_still_bonus_score
        self.env.internal_state["info"][f"env_info/standing_xy_velocity_norm"] = standing_xy_velocity_norm
        self.env.internal_state["info"][f"env_info/standing_yaw_velocity_norm"] = standing_yaw_velocity_norm
        self.env.internal_state["info"][f"env_info/standing_nominal_joint_pos_norm"] = standing_nominal_joint_pos_norm
        self.env.internal_state["info"][f"env_info/standing_nominal_joint_pos_score"] = standing_nominal_joint_pos_score
