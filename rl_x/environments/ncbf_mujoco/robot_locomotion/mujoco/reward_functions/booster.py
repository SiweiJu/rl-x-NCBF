...
class BoosterReward:
    ...
    def reward_and_info(self, action):
        ...
        state["info"]["reward/torque"] = torque_reward
        state["info"]["reward/energy"] = energy_reward
        state["info"]["reward/z_vel"] = z_vel_reward
        state["info"]["reward/roll_pitch_vel"] = roll_pitch_vel_reward
        state["info"]["reward/joint_vel"] = joint_vel_reward
        state["info"]["reward/joint_acc"] = acceleration_reward
        state["info"]["reward/root_acc"] = root_acceleration_reward
